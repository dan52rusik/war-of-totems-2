...
public class AgeOfWarAgent : Agent
{
    ...
    static readonly Vector3 SingleEnvCameraOffset = new Vector3(0f, 2.56f, -10.99119f);
    ...
    void AlignMainCameraToEnv()
    {
        ...
        if (AgentMaster != null && AgentMaster.number_of_envs != 1)
        {
            return;
        }

        Transform cameraTransform = Camera.main.transform;
        cameraTransform.position = env_object.transform.position + SingleEnvCameraOffset;
    }
